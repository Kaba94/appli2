...
abstract class BaseFixture extends Fixture
{
    ...
    /** @var Generator */
    protected $faker;
    /** @var array Liste des références connues (cf. mémoïsation) */
    private $references = [];
    ...
    /**
     * Récuperer une entité par son nom de référence
     * @param string $groupName nom du goupe de référence
     */
    protected function getRandomReference(string $groupName)
    {
        ...
        if(!isset($this->references[$groupName])) {
            ...
            foreach ($this->referenceRepository->getReferences() as $key => $ref) {
                // La clé $jey correspond à nos références
                // Si $key commence par le nom de groupe demandé($groupName), on le sauvegarde
